...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    {
        // Lấy employee_id từ route
        $employeeId = $this->route('employee')->id;
        // Lấy user_id từ input
        ...
        return [
            ...
            'email' => [
                'required',
                'email:rfc', // Chỉ kiểm tra format, không kiểm tra DNS
                Rule::unique('users')->ignore($userId) // Bỏ qua email hiện tại của user
            ],
