...
class AnnouncementsController extends Controller
{
    ...
    public function store(StoreAnnouncementRequest $request)
    {
        ...
        Log::create([
            'description' => auth()->user()->employee->name . " đã tạo một thông báo có tiêu đề '" . $request->input('title') . "'"
        ]);

        return redirect()->route('announcements')->with('status', 'Tạo thông báo thành công.');
    }
    ...
    public function update(StoreAnnouncementRequest $request, Announcement $announcement)
    {
        ...
        Log::create([
            'description' => auth()->user()->employee->name . " đã cập nhật một thông báo có tiêu đề '" . $announcement->title . "'"
        ]);

        return redirect()->route('announcements')->with('status', 'Cập nhật thông báo thành công.');
    }
    ...
    public function destroy(Announcement $announcement)
    {
        ...
        Log::create([
            'description' => auth()->user()->employee->name . " đã xóa một thông báo có tiêu đề '" . $announcement->title . "'"
        ]);

        return redirect()->route('announcements')->with('status', 'Xóa thông báo thành công.');
    }
