...
class RolesController extends Controller
{
    ...
    public function store(StoreRoleRequest $request)
    {
        ...
        return redirect()->route('roles')->with('status', 'Tạo chức vụ thành công.');
    }
    ...
    public function update(StoreRoleRequest $request, Role $role)
    {
        ...
        Log::create([
            'description' => auth()->user()->employee->name . " đã cập nhật thông tin chức vụ có tên '" . $role->name . "'"
        ]);

        return redirect()->route('roles')->with('status', 'Cập nhật chức vụ thành công.');
    }
    ...
    public function destroy(Role $role)
    {
        ...
        Log::create([
            'description' => auth()->user()->employee->name . " đã xóa chức vụ có tên '" . $role->name . "'"
        ]);

        return redirect()->route('roles')->with('status', 'Xóa chức vụ thành công.');
    }
