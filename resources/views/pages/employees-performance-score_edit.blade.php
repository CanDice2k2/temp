...
<div class="container-fluid mt-2 px-4">
  ...
  <div class="row">
    <div class="col-12">
        <h5 class="text-center font-weight-bold mb-3">Chỉnh sửa điểm của nhân viên</h5>
            ...
            @foreach ($scores as $score)
              <div class="row">
                <div class="col-sm-12 col-lg-2">
                  <div class="form-group">
                    <label for="{{ $score->scoreCategory->name }}">Danh mục</label>
                ...
                <div class="col-sm-12 col-lg-10">
                  <div class="form-group">
                    <label for="{{ $score->scoreCategory->name . '_score' }}">Điểm</label>
