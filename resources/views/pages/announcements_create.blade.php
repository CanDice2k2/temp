...
<div class="container-fluid mt-2 px-4">
  ...
  <div class="row">
    <div class="col-12">
        <h5 class="text-center font-weight-bold mb-3">Tạo thông báo mới</h5>
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Nhập tiêu đề" required>
                </div>
                @error('title')
            ...
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" name="description" id="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" placeholder="Nhập mô tả" required>
                </div>
                @error('description')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
