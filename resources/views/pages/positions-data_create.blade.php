            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="description" id="description" class="form-control @error('description') is-invalid @enderror" value="{{ old('description') }}" placeholder="Nhập mô tả chức vụ" required>
                </div>
                @error('description')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="row">
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="number" name="min_year_exp_required" id="min_year_exp_required" class="form-control @error('min_year_exp_required') is-invalid @enderror" value="{{ old('min_year_exp_required') }}" placeholder="Nhập số năm kinh nghiệm tối thiểu" required>
                </div>
              ...
              <div class="col-sm-12 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="number" name="salary" id="salary" class="form-control @error('salary') is-invalid @enderror" value="{{ old('salary') }}" placeholder="Nhập lương chức vụ" required>
                </div>
                @error('salary')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
